...
| `pre-registration-v3` | Severe weather forecasting (calibrator-v3.0, richer inputs) | [docs/PRE_REGISTRATION_v3.md](docs/PRE_REGISTRATION_v3.md) | — | Forward-only verification in flight; first sample ~2026-05-18 |
